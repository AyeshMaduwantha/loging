...
using loginAssignment.Helper;
using loginAssignment.Model;
using loginAssignment.Model.DataManager;
...
namespace loginAssignment
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<UserContext>(opts => opts.UseSqlServer("server = (localDB)\\MSSQLLocalDB; database = UserDB1; Integrated Security = True; "));
